...
ablation,
$\{\texttt{RTLO\_lag4},\ \texttt{RTLO\_mean24},\ \texttt{RTLO\_lag48},\
\texttt{RTLO\_lag168},\ \texttt{RTLO\_mean168}\}$,
which avoids redundant near-term load lags while preserving the daily and weekly
