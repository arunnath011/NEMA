...
The contributions are fivefold: a direct per-horizon design that lowers average MAE by
...
train/serve weather-source mismatch that had nearly doubled live error; a
horizon-matched, leakage-audited evaluation protocol against an operational ISO
forecast; and a keyless, fully reproducible pipeline built entirely on free public data. On a full year of held-out 2025 data, Beacon attains a day-ahead (h=24) MAE
