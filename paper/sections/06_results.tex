...
We organise the evaluation around four questions. We first
establish Beacon's accuracy on the held-out 2025 test set
...
\begin{tabular}{lcc}
\toprule
Configuration & MAE$_{h1}$ & MAE$_{h24}$ \\
\midrule
Lags only (OWM) & $78.7$ & $183.0$ \\
\;+ target weather (OWM) & $77.7$ & $110.3$ \\
\;+ Open-Meteo (\textbf{final}) & $\mathbf{60.9}$ & $\mathbf{76.7}$ \\
\bottomrule
\end{tabular}
\end{table}
