...
it reaches a day-ahead MAE of 89.3~MW against ISO New England's 92.6~MW. The
remainder of the paper details the data (Section~\ref{sec:related} situates the
work; subsequent sections cover data, method, setup, and results).
